...
appetizers.menu_items.create!(image: "missing.gif", title: "Tuna Poke", description: "tuna cubes, avocado, seaweed, togarashi", price: 995)
appetizers.menu_items.create!(image: "missing.gif", title: "Miso Soup", description: "dashi, bonito, tofu", price: 5467)
appetizers.menu_items.create!(image: "missing.gif", title: "Fried Octopus", description: "baby octopus, sesame, ginger, soy sauce, light fried", price: 4995)
appetizers.menu_items.create!(image: "missing.gif", title: "Edamame", description: "soy beans, soy sauce, togarashi", price: 1995)
appetizers.menu_items.create!(image: "missing.gif", title: "Tempura Veggies", description: "cauliflowers, carrots, sweet potato, broccoli", price: 5995)
appetizers.menu_items.create!(image: "missing.gif", title: "Seaweed Salad", description: "seaweed, soy sauce, scallions, ginger, cilantro, pepper flakes", price: 3241)
